...
public class FastRecyclerViewActivity extends AppCompatActivity {

    public static void start(Context context) {
        Intent intent = new Intent(context, FastRecyclerViewActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new FastRecyclerViewAdapter(mockData()));
    }
